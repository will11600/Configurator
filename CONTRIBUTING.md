...
1. Make an [Issue](https://github.com/william-brocklesby/unity-configurator/issues/new)
...
```json
    {
        "dependencies": {
            "com.william-brocklesby.unity-configurator": "https://github.com/YOUR_USER/unity-configurator.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at enquiries@william-brocklesby.com.
